TargetBot.Creature.edit = function(config, callback) -- callback = function(newConfig)
  ...
  addScrollBar("lureMax", "Dynamic lure max", 1, 30, 8)
  addScrollBar("lureDelay", "Dynamic lure delay", 100, 1000, 350)
  ...
  addCheckBox("dynamicLure", "Dynamic lure", true)
  addCheckBox("dynamicLureDelay", "Dynamic lure delay", true)
